...
const LoginForm = () => {
  ...
  return (
    <form
      ...
      autoComplete="off" // Ensure autofill is off for the form
    >
      <label className="w-full">
        ...
        <input
          type="email" // Ensure input type is email for better autofill control
          name="email"
          value={email}
          onChange={handleOnChange}
          placeholder="Enter email address"
          autoComplete="off" // Ensure autofill is off for the input
          style={{
